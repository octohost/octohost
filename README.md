...
A full installation includes:
  ...
  1. [Docker 0.7.1](http://www.docker.io/)
...
```
ec2-run-instances --key your-key -g group-with-22-and-80-open ami-2c187c1c --user-data-file user-data-file/setup --region us-west-2
